...
export default function JunkBar(props) {
  const { anchor, overrides, ...rest } = props;
  const homeOnClick = useNavigateAction({ type: "url", url: "/" });
  const junkOnClick = useNavigateAction({ type: "url", url: "/junk" });
  const aboutOnClick = useNavigateAction({ type: "url", url: "/about" });
  const contactOnClick = useNavigateAction({ type: "url", url: "/contact" });
  const adminOnClick = useNavigateAction({ type: "url", url: "/admin" });
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "JunkBar")}
      {...rest}
    >
      <Flex
        gap="20px"
      ...
      >
        ...
        <Button
          ...
          {...getOverrideProps(overrides, "Junk")}
        ></Button>
        <Button
          width="unset"
          height="unset"
